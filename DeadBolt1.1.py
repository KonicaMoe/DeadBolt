...
def encryptpass():
    if options == "1":
        input("Are u sure u want to do this? If the pass is gone your file is dead and or fucked. I dont want to code it in so press CTRL+C to abort to continue enter")
...
def encryptkey():
    if options == "2":
        answer = input("Are you sure to proceed? If you loose your key file your file is Fucked!!! Type y to accept\n")
        proceed = "y"
...
def decryptkey():
    if options == "2":
        ...
        with open(file, "wb") as thefile:
            thefile.write(content_decrypted)
            print("file has been decrypted, nois m8")
            final = input("Press enter to exit")
            quit()
